...
* a) technické správy a vývoje [systémů strany](http://www.pirati.cz/rules/stto?rev=1316904951#systemy_strany),

* b) integrací [přidružených systémů](http://www.pirati.cz/rules/stto?rev=1316904951#pridruzene_systemy) a systémů třetích stran.
...
(3) Zakazuje se bez povolení příslušného administrátora ([§3](http://www.pirati.cz/rules/stto?rev=1316904951#systemy_strany) až [§5](http://www.pirati.cz/rules/stto?rev=1316904951#systemy_tretich_stran)) vydaného ve spolupráci s republikovým předsednictvem v případech pro stranu prospěšných:
...
* a) seznam domén třetího řádu podle [§3a(1) StTO](http://www.pirati.cz/rules/stto?rev=1316904951#a_domeny),

* b) seznam projektů s vlastní doménou doménou druhého řádu,

* c) seznam dalších adres podle [§10(4) StTO](http://www.pirati.cz/rules/stto?rev=1316904951#e-mail).
