...
1) Členové republikového výboru mezi sebou vybírají 3 až 5 jednatelů, kteří výbor organizují, spravují a zastupují tam, kde to vyžaduje předpis((např. [§ 4 StOk](http://sbirka.pirati.cz/predpisy/stok/)], [§2 odst. 4 PraH](http://sbirka.pirati.cz/predpisy/prah/)).

(2) Pro účely ustanovení jednacího řádu (např. [§ 19 a), b) JdŘ](http://sbirka.pirati.cz/predpisy/jdr/)], [§ 25 JdŘ](http://sbirka.pirati.cz/predpisy/jdr/)], [§ 31 JdŘ](http://sbirka.pirati.cz/predpisy/jdr/)) případně dalších předpisů se jednatelé považují za orgán volený republikovým výborem a jednotliví jednatelé za funkcionáře volené republikovým výborem. 
...
K [§ 2(2) JdŘ](http://sbirka.pirati.cz/predpisy/jdr/)
...
K [§ 3 JdŘ](http://sbirka.pirati.cz/predpisy/jdr/), [§ 6 JdŘ](http://sbirka.pirati.cz/predpisy/jdr/):
...
* c) c) pověřenec odboru, [§ 18(2) StOK](http://sbirka.pirati.cz/predpisy/stok/)
...
(4) Uzavřená jednání musí být zveřejněno nejpozději týden před koncem volebního období republikového výboru. [§ 18, odst. 4 StOk]((http://sbirka.pirati.cz/predpisy/stok/)

K [§ 15, odst 1 Jednacího řádu](http://sbirka.pirati.cz/predpisy/jdr/), § 19 Jednacího řádu, § 27 Jednacího řádu a § 31 Jednacího řádu:
 ...
 * d) republikovému výboru není předložen rozpočet, výsledky hospodaření nebo výroční finanční zpráva ve lhůtě ([§ 4 RoPr](http://sbirka.pirati.cz/predpisy/ropr/)) 
 ...
 * g) byl vyhlášen termín voleb pro něž je třeba připravit společný volební program. ([§ 14 Volebního řádu](http://sbirka.pirati.cz/predpisy/vr/))
 ...
 * b) probíhá volba celostátního fóra ([§ 19 Jednacího řádu](http://sbirka.pirati.cz/predpisy/jdr/)), do níž může výbor nominovat kandidáta [§ 21(b)](http://sbirka.pirati.cz/predpisy/jdr/) a skupina členů předloží návrh na nominaci takového kandidáta; Velikost skupiny se přitom určuje, jako by se jednalo o návrh na již probíhající jednání.
 ...
 * c) republikovému výboru nějaké rozhodnutí odkáže celostátní fórum v referendu ([§ 17 Jednacího řádu](http://sbirka.pirati.cz/predpisy/jdr/))
 * d) probíhá jednání o usnesení celostátního fóra ([§ 15 Jednacího řádu](http://sbirka.pirati.cz/predpisy/jdr/)) a skupina členů navrhne, aby republikový výbor v tomto jednání předložil svůj návrh; Velikost skupiny se přitom určuje, jako by se jednalo o návrh na již probíhající jednání, 
 * e) republikové předsednictvo, kontrolní nebo rozhodčí komise, nebo skupina členů předloží návrh na zrušení vyhlášky, ([§ 16 odst. 1 StOk](http://sbirka.pirati.cz/predpisy/stok/)
 * f) hospodář [§2 odst. 4 PraH](http://sbirka.pirati.cz/predpisy/prah/)) požádá republikový výbor o schválení záměru (viz § 10 odst. 1 Pravidel hospodaření) z rozpočtu organizační složky (§ 16 odst. 3 písm. a) PraH), jejímž je hospodářem, 
 ...
 * h) skupina členů, příslušné předsednictvo, jemu nadřízené předsednictvo, přezkumný orgán, republikové předsednictvo nebo zástupce příslušného kraje předloží návrh na změnu předloženého volebního programu, ([§ 17a Volebního řádu](http://sbirka.pirati.cz/predpisy/vr/)
 * i) skupina členů, příslušné předsednictvo, jemu nadřízené předsednictvo, přezkumný orgán, republikové předsednictvo nebo zástupce příslušného kraje v předloží návrh na změnu(doplnění, změnu pořadí či vyškrtnutí) kandidátní listiny [§ 17b Volebního řádu](http://sbirka.pirati.cz/predpisy/vr/); Účast a závěrečné slovo je v takovém případě dovoleno kandidátům, kterých se návrh týká, 
 * j) skupina členů, příslušné předsednictvo, jemu nadřízené předsednictvo, přezkumný orgán, republikové předsednictvo nebo zástupce příslušného kraje navrhnou provedení dohledu nad volební spoluprací [§ 16 Volebního řádu](http://sbirka.pirati.cz/predpisy/vr/)
...
K [§ 33, odst. 2 JdŘ](http://sbirka.pirati.cz/predpisy/jdr/)
...
K [§ 37 JdŘ](http://sbirka.pirati.cz/predpisy/jdr/)
